...
const Experience = () => {
  const Frontend = [
    ...
    { name: "PHP", src: PHP, experiences: "Experienced", id: 3 },
    {
      name: "ES6",
      src: ES,
    ...
    { name: "Bootstrap", src: BOOTSTRAP, experiences: "Experienced", id: 5 },
  ...
  const Backend = [
    ...
    { name: "MYSQL", src: MYSQL, experiences: "Intermediate", id: 2 },
